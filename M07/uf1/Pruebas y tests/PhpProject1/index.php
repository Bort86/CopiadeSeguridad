...
if (filter_has_var(INPUT_POST, "send")) {
    ...
    $select = filter_input(INPUT_POST, "radio1");
}
    ...
    <body>
        ...
        <form action= "<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <input type="radio" id="id_radio1" name="radio1" value="<?=$select?>" checked> Blue <br>
                <input type="radio" id="id_radio2" name="radio1" value="<?=$select?>"> Black <br>
                <input type="radio" id="id_radio3" name="radio1" value="<?=$select?>"> Red <br>
            </fieldset>
